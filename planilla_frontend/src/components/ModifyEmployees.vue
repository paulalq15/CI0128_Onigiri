      ...
      >
        ...
        <div class="mb-3 col-xl-6 col-sm-12">
          ...
          <input
            ...
            required
            maxlength="60"
            v-model="model.personData.name1"
          />
        ...
        <div class="mb-3 col-xl-6 col-sm-12">
          ...
          <input
            ...
            id="secondNameE"
            maxlength="60"
            v-model="model.personData.name2"
          />
        </div>
        <div class="mb-3 col-xl-6 col-sm-12">
          ...
          <input
            ...
            required
            maxlength="60"
            v-model="model.personData.surname1"
          />
        ...
        <div class="mb-3 col-xl-6 col-sm-12">
          ...
          <input
            ...
            required
            maxlength="60"
            v-model="model.personData.surname2"
          />
        ...
        <div class="mb-3 col-xl-4 col-sm-12">
          ...
          <input
            ...
            pattern="[0-9]{4}-[0-9]{4}"
            v-model="model.personData.phone"
          />
        ...
        <div class="mb-3 col-xl-6 col-sm-12">
          ...
          <select
            ...
            @change="getDistricts"
            :disabled="!Direccion.selectedProvince || counties.length === 0"
          >
        ...
        <div class="mb-3 col-xl-6 col-sm-12">
          ...
          <select
            ...
            @change="getZipCode"
            :disabled="!Direccion.selectedCanton || districts.length === 0"
          >
        ...
        <div class="mb-3 col-xl-6 col-sm-12">
          ...
          <input
            ...
            id="position"
            maxlength="80"
            v-model="model.contractData.position"
          />
        </div>
        <div class="mb-3 col-xl-6 col-sm-12">
          ...
          <input
            ...
            id="department"
            maxlength="80"
            v-model="model.contractData.department"
          />
        </div>
        <div class="mb-3 col-xl-6 col-sm-12">
          ...
          <input
            ...
            :min="0"
            step="0.01"
            v-model.number="model.contractData.salary"
          />
        ...
        <div class="mb-3 col-xl-6 col-sm-12">
          ...
          <input
            ...
            id="iban2"
            :pattern="ibanPattern"
            v-model.trim="model.contractData.bankAccount"
          />
...
const zipCodeValue = computed(() => model?.direction?.zipCode ?? '');
...
function parseSession() {
  ...
  employerId.value = user.personId ?? null;
}
...
async function onSubmit() {
  ...
  if (!targetPersonId.value) {
    useGlobalAlert().show('Indique IdPersona y presione Cargar', 'warning');
    return;
  }
  const payload = buildPayload();
  try {
    await URLBaseAPI.put(
      `/api/Employee/emp/${employerId.value}/employee/${targetPersonId.value}`,
      payload
    );
