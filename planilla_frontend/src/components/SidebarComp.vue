<template>
    <div class="offcanvas offcanvas-end" tabindex="-1" id="appSidebar" aria-labelledby="sidebarLabel" data-bs-backdrop="false" data-bs-scroll="true">
        ...
        <div class="offcanvas-body">
            ...
            <ul class="list-unstyled ps-0"> 
                ...
                <li class="my-3">
                    <RouterLink class="link-body-emphasis text-decoration-none" to="/Home" @click="closeSidebar">
                    ...
                    <div class="collapse" id="company-collapse">
                        <ul class="list-unstyled ms-4 ps-2 small">
                            ...
                            <li>
                                <RouterLink
                                    class="nav-link my-2"
                                    to="/CrearEmpresa" @click="closeSidebar">Crear Empresa
                                </RouterLink>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="my-3">
                    <button
                        class="nav-link d-flex w-100"
                        data-bs-toggle="collapse" data-bs-target="#timesheet-collapse" aria-expanded="false">
                ...
                <li class="my-3">
                    <button
                        class="nav-link d-flex w-100"
                        data-bs-toggle="collapse" data-bs-target="#payroll-collapse" aria-expanded="false">
                ...
                <li class="my-3">
                    <RouterLink class="nav-link link-danger text-decoration-none" to="/" @click="closeSidebar">
